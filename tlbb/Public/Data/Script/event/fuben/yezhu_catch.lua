...
x402105_g_LimitMembers = BAOZOU_YEZHU_MIN_ENTRY_PLAYER_COUNT				--可以进副本的最小队伍人数
...
function x402105_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if LuaFnHasTeam(sceneId,selfId) < 1  then
		BeginEvent(sceneId)
			...
			AddText(sceneId,"  人多力量大，我们凑齐人手再出发！#R(需要是队长，并且队伍中至少"..BAOZOU_YEZHU_MIN_ENTRY_PLAYER_COUNT.."人)");
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
		return
	end
