...
function SelfEquip_SetStateTooltip()
	...
	SelfEquip_IceFastness:SetToolTip("冰攻:"..string.format("%.0f", iIceAttack).."#r冰抗:"..string.format("%.0f", iIceDefine).."#r减冰抗:"..string.format("%.0f", iIceResistOther) );
	SelfEquip_FireFastness:SetToolTip("火攻:"..string.format("%.0f", iFireAttack).."#r火抗:"..string.format("%.0f", iFireDefine).."#r减火抗:"..string.format("%.0f", iFireResistOther) );
	SelfEquip_ThunderFastness:SetToolTip("玄攻:"..string.format("%.0f", iThunderAttack).."#r玄抗:"..string.format("%.0f", iThunderDefine).."#r减玄抗:"..string.format("%.0f", iThunderResistOther) );
	SelfEquip_PoisonFastness:SetToolTip("毒攻:"..string.format("%.0f", iPoisonAttack).."#r毒抗:"..string.format("%.0f", iPoisonDefine).."#r减毒抗:"..string.format("%.0f", iPoisonResistOther) );
