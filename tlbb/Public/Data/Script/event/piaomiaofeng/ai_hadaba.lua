...
--buff....
x402264_Buff_MianYi1	= 10472	--免疫一些负面效果....
x402264_Buff_MianYi2	= 10471	--免疫普通隐身....
...
--AI Index....
x402264_IDX_CombatTime		= 1	--进入战斗的计时器....用于记录已经进入战斗多长时间了....
x402264_IDX_UseSkillIndex	= 2	--接下来该使用技能表中的第几个技能....

x402264_IDX_CombatFlag 			= 1	--是否处于战斗状态的标志....
x402264_IDX_IsKuangBaoMode	= 2	--是否处于狂暴模式的标志....
...
function x402264_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#{_INFOUSR%s}#{PMF_8812_01}", playerName); --哈大霸
