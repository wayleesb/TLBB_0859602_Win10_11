...
function LifeSkillsStudy_OnEvent(event)
	...
	elseif(event == "UNIT_EXP" and this:IsVisible()) then
		...
		LifeSkillsStudy_CurrentlyExp_Character_Text:SetText("当前经验:" .. string.format("%.0f", nExpNow));
...
function LifeSkillsStudy_UpdateFrame()
	...
	LifeSkillsStudy_DemandExp_Character_Text:SetText("所需经验:" .. string.format("%.0f", nNeedExp));
