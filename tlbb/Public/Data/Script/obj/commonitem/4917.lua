...
--		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, x334917_g_Impact1, 0);
		...
		if(0<=targetId) then
			if LuaFnIsFriend(sceneId, targetId, selfId) > 0 then
				...
				BeginEvent(sceneId)
			    AddText(sceneId, "你与对方的友好度增加了500");
			  EndEvent(sceneId)
			  DispatchMissionTips(sceneId,selfId)
			  
			  local	namSelf		= GetName( sceneId, selfId )
			  local	namTarget	= GetName( sceneId, targetId )
				local	str	= format( "#B#{_INFOUSR"..namSelf.."}#g7ffff0亲手把#g000000#W[99朵玫瑰]#g7ffff0送到#g000000#B#{_INFOUSR"..namTarget.."}#g7ffff0手中，深情地看着#g000000#B#{_INFOUSR"..namTarget.."}#g7ffff0。" )
