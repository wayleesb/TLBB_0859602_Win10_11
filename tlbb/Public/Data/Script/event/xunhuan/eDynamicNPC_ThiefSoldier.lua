...
x050013_g_LimitMembers			= ZEIBINGRUQIN_MIN_ENTRY_PLAYER_COUNT		--可以进副本的最小队伍人数
...
function x050013_OnEnumerate( sceneId, selfId, targetId )
	...
	if GetTeamSize( sceneId, selfId ) < x050013_g_LimitMembers then
	  AddText( sceneId, "想要挑战我至少也得上来"..ZEIBINGRUQIN_MIN_ENTRY_PLAYER_COUNT.."个吧，就这点人？也太瞧不起我了。" )
	  return
	end
