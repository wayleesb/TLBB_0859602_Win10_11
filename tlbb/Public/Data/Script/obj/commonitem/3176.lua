...
--脚本号
x333176_g_scriptId = 333176 --临时写这个,真正用的时候一定要改.

--需要的等级

--效果的ID
x333176_g_Impact1 = 3176 --临时写这个
x333176_g_Impact2 = -1 --不用
X333176_g_DepletedHp = 20 --消耗的法力
--**********************************
--事件交互入口
--**********************************
...
function x333176_OnDeplete( sceneId, selfId )
	...
	IncreaseHp(sceneId, selfId, -X333176_g_DepletedHp) --消耗掉相应的MP
