...
x800202_g_scriptParamIndex_xibao = 0;		--喜包时间
x800202_g_scriptParamIndex_xibao_TI = 1;	--喜包发放的时间间隔
x800202_g_scriptParamIndex_lihua = 2;		--礼花时间
x800202_g_scriptParamIndex_lihua_TI = 3;	--礼花发放的时间间隔

x800202_g_timeInterval_xibao = 1000 * 10;	--标准喜包发放的时间间隔
x800202_g_timeInterval_lihua = 1000 * 1;	--标准礼花发放的时间间隔
x800202_g_maxXibaoCount = 10;							--每次的喜包数量

x800202_g_itemBoxPos_dropRange_min = 2;			--喜包的掉落范围
x800202_g_itemBoxPos_dropRange_max = 4;			--喜包的掉落范围

x800202_g_gemDropRate = 3;					--出宝石权重(x%)

x800202_g_medicineDropCount_min = 1;		--出药品的最小数目
x800202_g_medicineDropCount_max = 6;		--出药品的最大数目
