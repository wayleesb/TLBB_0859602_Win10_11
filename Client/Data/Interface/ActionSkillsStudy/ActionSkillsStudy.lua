...
function ActionSkillsStudy_OnEvent(event)
	...
	elseif(event == "UNIT_EXP") then
		...
		ActionSkillsStudy_CurrentlyExp_Character_Text:SetText("当前经验:" .. string.format("%.0f", nExpNow));
...
function ActionSkillsStudy_XinfaInfo_Update( nIndex )--XinfaID
	...
	ActionSkillsStudy_DemandExp_Character_Text:SetText("所需经验:" .. string.format("%.0f", nExp));
