...
x331026_g_itemList[30509033] = {effect=6, time=60,
	msg1="#W#{_INFOUSR%s}#H正要与某武林高手比武，心中一动，提前使用了一个%s#H，但见满天竹叶飞舞，登时变得气势凌人起来。",
	msg2="#W#{_INFOUSR%s}#H正要与某武林高手在#G%s#H比武，心中一动，提前使用了一个%s#H，但见满天竹叶飞舞，登时变得气势凌人起来。"}
...
x331026_g_itemList[30509052] = {effect=10, time=60,
	msg1="#H五月，是一场雷鸣后大雨来临，南飞的大雁跋山涉水归家的日子；在这烂漫的季节#W#{_INFOUSR%s}#H使用了一个#W%s#H，借以赞美这冬麦扬穗农民挥汗荷锄，辛勤耕耘的好光景。",
