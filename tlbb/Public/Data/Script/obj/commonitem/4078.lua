...
--脚本号
x334078_g_scriptId = 334078 --临时写这个,真正用的时候一定要改.
...
--AE的目标关系标记
x334078_g_standFlag = 1 -- 2:队友， 1：友军， -1：敌军
--AE影响数目限制
x334078_g_effectCount = 4 -- -1:不限制
--效果的ID
x334078_g_Impact1 = 4078 --临时写这个
x334078_g_Impact2 = -1 --不用
