...
function x000110_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x000110_g_scriptId, "材料合成介绍", 11, 20 ) -- add by cuiyinjie 20081021
		AddNumText( sceneId, x000110_g_scriptId, "宝石合成", 6, 1 )
		AddNumText( sceneId, x000110_g_scriptId, "装备打孔", 6, 2 )
