...
function x001194_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x001194_g_scriptId, "宝石相关介绍", 11, 0 )
		AddNumText( sceneId, x001194_g_scriptId, "材料合成介绍", 11, 20 ) -- add by cuiyinjie 20081021
		AddNumText( sceneId, x001194_g_scriptId, "宝石合成", 6, 1 )
		AddNumText( sceneId, x001194_g_scriptId, "装备打孔", 6, 2 )
		AddNumText( sceneId, x001194_g_scriptId, "宝石摘除", 6, 3 )
		AddNumText( sceneId, x001194_g_scriptId, "材料合成", 6, 4 )
		AddNumText( sceneId, x001194_g_scriptId, "宝石镶嵌", 6, 5 )
		AddNumText( sceneId, x001194_g_scriptId, "宝石雕琢", 6, 6 )
		AddNumText( sceneId, x001194_g_scriptId, "宝石熔炼", 6, 7 )
...
function x001194_OnEventRequest( sceneId, selfId, targetId, eventId )
		...
		if GetNumText() == 0 then
			BeginEvent(sceneId)	
				...
				AddNumText(sceneId, x001194_g_scriptId,"装备打孔介绍",11,8);
				AddNumText(sceneId, x001194_g_scriptId,"宝石合成介绍",11,9);
				AddNumText(sceneId, x001194_g_scriptId,"宝石镶嵌介绍",11,10);
				AddNumText(sceneId, x001194_g_scriptId,"宝石摘除介绍",11,11);
--				AddNumText(sceneId, x001194_g_scriptId,"装备修理介绍",11,12);
				AddNumText(sceneId, x001194_g_scriptId,"宝石雕琢介绍",11,13);
				AddNumText(sceneId, x001194_g_scriptId,"宝石熔炼介绍",11,14);
				AddNumText(sceneId, x001194_g_scriptId,"胜利宝石介绍",11,15);
		...
		if GetNumText() == 20 then  -- add by cuiyinjie 材料合成介绍
			BeginEvent(sceneId)			
				...
				AddNumText(sceneId, x001194_g_scriptId,"精铁的操作介绍",11,21);
				AddNumText(sceneId, x001194_g_scriptId,"秘银的操作介绍",11,22);
				AddNumText(sceneId, x001194_g_scriptId,"棉布的操作介绍",11,23);					
			EndEvent(sceneId)
			DispatchEventList(sceneId,selfId,targetId)
			return
		end
