...
function x334904_OnDeplete( sceneId, selfId )
	...
	if(LuaFnDepletingUsedItem(sceneId, selfId)) then
		...
		if itmId > 0 then
			...
			local	str	= format( "#B#{_INFOUSR"..namSelf.."}#cff0000亲手把#W["..namItem.."]#cff0000送到#B#{_INFOUSR"..namTarget.."}#cff0000手中，深情地看着#B#{_INFOUSR"..namTarget.."}#cff0000。" )
